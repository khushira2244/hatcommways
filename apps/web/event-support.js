...
window.HatcommwaysSupport = (() => {
  ...
  function submitMode() {
    ...
    // Scrolling over a focused quantity must not silently step it by 0.001.
    quantity.addEventListener('wheel',event=>{if(document.activeElement===quantity)event.preventDefault();},{passive:false});

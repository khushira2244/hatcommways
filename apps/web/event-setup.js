...
function renderSetup() {
  ...
  document.querySelector('#event-latitude').value = setupState.map_settings.event_latitude ?? '';
  document.querySelector('#event-longitude').value = setupState.map_settings.event_longitude ?? '';
  document.querySelector('#map-area-label').value = setupState.map_settings.area_label || '';
...
function snapshot() {
  return {
    ...
    event_media: setupState.event_media || [], cover_image_data_url: setupState.cover_image_data_url || null,
    map_settings: {map_enabled:document.querySelector('#map-enabled').checked,default_view:optional(document.querySelector('#default-view').value),event_latitude:document.querySelector('#event-latitude').value?Number(document.querySelector('#event-latitude').value):null,event_longitude:document.querySelector('#event-longitude').value?Number(document.querySelector('#event-longitude').value):null,area_label:optional(document.querySelector('#map-area-label').value),participation_dimensions:[...document.querySelectorAll('[name="dimension"]:checked')].map(input=>input.value)},
